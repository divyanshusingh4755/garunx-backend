...
export class NotificationEventHandler {
    ...
    static async handleFamilyTreeMemberUpdated(params) {
        ...
        const changedFields = Array.isArray(rawChangedFields) ? rawChangedFields.filter((value) => typeof value === "string").join(", ") : "";
        return NotificationService.createFromTemplate({
            recipientId: ownerId,
            recipientRole: Role.USER,
