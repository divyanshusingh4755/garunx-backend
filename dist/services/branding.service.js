...
class BrandingService {
    ...
    static async exportBrandingToCsv(brandingIds) {
         ...
         */
        const brandingMap = new Map(brandingRecords.map((branding) => [
            branding._id
                .toString(),
            branding,
        ]));
        const orderedBranding = uniqueBrandingIds
            .map((brandingId) => brandingMap.get(brandingId))
        ...
        const rows = orderedBranding.map((branding) => [
            branding._id
                .toString(),
            branding.version,
            branding.isActive,
            ...
            branding.theme
                .text,
            formatDate(branding.createdAt),
            formatDate(branding.updatedAt),
        ]);
        const csv = [
            headers
                .map(escapeCsv)
