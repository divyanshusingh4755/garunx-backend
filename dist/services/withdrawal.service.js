...
export class WithdrawalService {
    ...
    static async cancelWithdrawal(params) {
    ...
    static async markPaid(params) {
        ...
        const allowedMethods = ["NEFT", "IMPS", "RTGS", "UPI", "BANK_TRANSFER", "OTHER"];
    ...
    static async getMyWithdrawals(params) {
        this.validateOwnerRole(params.ownerRole);
        const ownerId = this.objectId(params.ownerId, "owner ID");
        if (params.status) {
        ...
        const filter = { ownerId, ownerRole: params.ownerRole };
        if (params.status) {
    ...
    static async getMyWithdrawalById(params) {
        this.validateOwnerRole(params.ownerRole);
        const withdrawalId = this.objectId(params.withdrawalRequestId, "withdrawal request ID");
        const ownerId = this.objectId(params.ownerId, "owner ID");
    ...
    static async getAllWithdrawals(params) {
        ...
        if (params.ownerRole) {
            filter.ownerRole = params.ownerRole;
        }
        ;
        if (params.ownerId) {
            filter.ownerId = this.objectId(params.ownerId, "owner ID");
        }
    ...
    // Admin detail
    static async getWithdrawalById(withdrawalRequestId) {
    ...
    static async assertAdmin(adminId, session) {
    ...
    static sanitizeWithdrawalForOwner(withdrawal) {
