    ...
    static async buildPackageBooking(cart) {
        ...
        for (const selectedService of selectedCartServices) {
            if (!selectedService.serviceId) {
                throw new Error("Invalid selected package service: serviceId is missing");
            }
        ...
        for (const addonService of addonCartServices) {
            if (!addonService.serviceId) {
                throw new Error("Invalid addon package service: serviceId is missing");
            }
