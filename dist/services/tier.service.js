...
export class TierService {
    static async invalidateTierCache(tierId) {
        const operations = [RedisCacheService.deleteByPattern(CacheKeys.tierListPattern())];
        if (tierId) {
    ...
    static async toggleTierStatus(id, isActive, confirmed = false) {
        ...
        if (tier.isActive === isActive) {
            return { success: true, requiresConfirmation: false, isActive: tier.isActive, message: `Tier already ${isActive ? "active" : "inactive"}` };
        }
        if (!isActive && !confirmed) {
            ...
            if (hasImpact) {
                return { success: true, requiresConfirmation: true, message: "Tier is used in services and packages. Are you sure?", impact };
            }
        }
        ...
        return { success: true, requiresConfirmation: false, isActive, message: `Tier ${isActive ? "activated" : "deactivated"} successfully` };
    }
