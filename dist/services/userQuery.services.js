...
export class UserQueryService {
    static async invalidateUserQueryCache(queryId) {
        const operations = [
        ...
        if (queryId) {
            operations.push(RedisCacheService.deleteByPattern(`${CACHE_PREFIX}:user-query:user-detail:${queryId}:*`), RedisCacheService.delete(CacheKeys.userQueryAdminDetail(queryId)));
        }
    ...
    static async exportUserQueriesToCsv(queryIds) {
        ...
        const rows = orderedQueries.map((query) => {
