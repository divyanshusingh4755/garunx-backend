...
const exportBookingsValidation = [
    body("bookingIds")
        ...
        .withMessage("bookingIds must contain between 1 and 1000 booking IDs"),
    body("bookingIds.*")
        .isMongoId()
        .withMessage("Each bookingId must be a valid MongoDB ID"),
    validate,
];
export const coordinatorSelectionConfigValidation = [
    body("matchCaste")
        .isBoolean()
        .withMessage("matchCaste must be boolean"),
    body("matchGotra")
        .isBoolean()
        .withMessage("matchGotra must be boolean"),
    body("minRating")
        .isFloat({
        min: 0,
        max: 5,
    ...
    body("minCompletedBookings")
        ...
        .withMessage("minCompletedBookings must be a non-negative integer"),
    ...
    body("sortBy")
        ...
        .withMessage("Invalid coordinator sort field"),
    body("sortOrder")
        .isIn([
        "asc",
        "desc",
...
router.get("/", authenticate, authorizeRoles(Role.ADMIN), requirePermission("booking.read"), query("page")
    ...
    .withMessage("limit must be between 1 and 100"), query("sortOrder")
    .optional()
    .isIn([
    "asc",
    "desc",
...
router.patch("/:bookingId/reschedule", authenticate, authorizeRoles(Role.USER), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("scheduledAt")
    .isISO8601()
    .withMessage("Valid scheduledAt is required"), body("reason")
    .isString()
    .trim()
    .notEmpty()
...
router.patch("/:bookingId/notes", authenticate, authorizeRoles(Role.USER), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("notes")
    .isString()
...
// ASSIGNMENT
// =========================================================
router.post("/:bookingId/assignment/select", authenticate, authorizeRoles(Role.USER), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("coordinatorId")
    .isMongoId()
    .withMessage("Invalid coordinator ID"), body("scheduledAt")
    .optional()
    .isISO8601()
    .withMessage("Invalid scheduledAt"), body("rescheduleReason")
    .optional()
    .isString()
    .trim()
    .isLength({
...
router.post("/:bookingId/assignment/respond", authenticate, authorizeRoles(Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("action")
    .isIn([
    "ACCEPT",
    "REJECT",
])
...
router.post("/:bookingId/assignment/reassign", authenticate, authorizeRoles(Role.USER, Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("reason")
    .isString()
    .trim()
...
router.post("/:bookingId/execution/services/:executionId/skip", authenticate, authorizeRoles(Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), param("executionId")
    .isUUID()
    .withMessage("Invalid execution ID"), body("reason")
    .isString()
    .trim()
    .notEmpty()
...
// =========================================================
router.post("/:bookingId/execution/milestones", authenticate, authorizeRoles(Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("code")
    .isString()
    .notEmpty()
    .withMessage("Milestone code is required"), body("notes")
    .optional()
    .isString()
    .isLength({
    max: 500,
...
router.post("/:bookingId/execution/verify-otp", authenticate, authorizeRoles(Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("otp")
    .matches(/^\d{6}$/)
...
router.post("/:bookingId/execution/complete", authenticate, authorizeRoles(Role.COORDINATOR), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("proofUrls")
    .isArray({
    min: 1,
})
    .withMessage("At least one completion proof is required"), body("proofUrls.*")
    .isURL()
    .withMessage("Every proof URL must be valid"), body("notes")
    .optional()
    .isString()
    .isLength({
    max: 1000,
...
// =========================================================
router.patch("/:bookingId/status", authenticate, authorizeRoles(Role.ADMIN), requirePermission("booking.status"), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("reason")
    .optional()
    .isString()
...
router.post("/:bookingId/refund", authenticate, authorizeRoles(Role.ADMIN), requirePermission("booking.refund"), param("bookingId")
    .isMongoId()
    .withMessage("Invalid booking ID"), body("amount")
    .isFloat({
    gt: 0,
})
