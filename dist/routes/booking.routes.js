...
router.get("/:bookingId/available-coordinators", authenticate, getAvailableCoordinators);
router.post("/:bookingId/assignment/select", authenticate, selectCoordinator);
router.post("/:bookingId/assignment/respond", authenticate, respondToAssignment);
router.post("/:bookingId/assignment/reassign", authenticate, requestReassignment);
// BOOKING EXECUTION ROUTES
router.get("/:bookingId/execution", authenticate, getBookingExecution);
router.post("/:bookingId/execution/arrived", authenticate, markCoordinatorArrived);
router.post("/:bookingId/execution/verify-otp", authenticate, verifyBookingOtp);
router.post("/:bookingId/execution/services/:executionId/start", authenticate, startBookingService);
router.post("/:bookingId/execution/services/:executionId/complete", authenticate, completeBookingService);
router.post("/:bookingId/execution/services/:executionId/skip", authenticate, skipBookingService);
router.post("/:bookingId/execution/milestones", authenticate, addBookingMilestone);
