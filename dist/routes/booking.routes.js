...
router.patch("/:bookingId/reschedule", authenticate, param("bookingId").isMongoId().withMessage("Invalid booking ID"), body("scheduledAt")
    .isISO8601()
...
router.post("/:bookingId/execution/milestones", authenticate, param("bookingId").isMongoId().withMessage("Invalid booking ID"), body("code")
    .isString()
    .notEmpty()
