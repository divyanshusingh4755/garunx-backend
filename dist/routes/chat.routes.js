...
const sendMessageValidation = [
    param("conversationId").isMongoId().withMessage("Invalid conversation ID"),
    body("clientMessageId").exists({ checkFalsy: true }).withMessage("Client message ID is required").isString().withMessage("Client message ID must be string").trim().notEmpty().withMessage("Client message ID cannot be empty"),
    body("type").exists({ checkFalsy: true }).isIn([
    ...
    body("images.*").optional().isString().withMessage("Each image must be a string").trim().notEmpty().withMessage("Image URL cannot be empty"),
    body().custom((value) => {
