...
router.put("/:cartId/components", optionalAuthenticate, param("cartId").isMongoId().withMessage("Invalid cartId"), body("selectedComponents")
    .isArray()
    .withMessage("selectedComponents must be an array"), validate, updateSelectedComponents);
router.put("/:cartId/addon-components", optionalAuthenticate, param("cartId").isMongoId().withMessage("Invalid cartId"), body("addonComponents")
    .isArray()
...
router.post("/:cartId/validate", optionalAuthenticate, param("cartId").isMongoId().withMessage("Invalid cartId"), body("persist")
    .optional()
    .isBoolean()
