 ...
 * Cart selections.
 */
router.put("/:cartId/components", optionalAuthenticate, updateSelectedComponents);
router.put("/:cartId/addon-components", optionalAuthenticate, updateAddonComponents);
router.put("/:cartId/selected-services", optionalAuthenticate, updateSelectedServices);
router.put("/:cartId/addon-services", optionalAuthenticate, updateAddonServices);
/*
 * Cart details.
 */
router.put("/:cartId/schedule", optionalAuthenticate, updateSchedule);
router.put("/:cartId/customer-details", optionalAuthenticate, updateCustomerDetails);
