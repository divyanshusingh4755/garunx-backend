...
const exportCartsValidation = [
    body("cartIds")
        ...
        .withMessage("cartIds must be a non-empty array"),
    body("cartIds.*")
        .isMongoId()
        .withMessage("Each cart ID must be valid"),
    validate,
];
...
// CART CREATION
// =========================================================
router.post("/service", optionalAuthenticate, body("serviceId")
    .notEmpty()
    .withMessage("serviceId is required")
    .isMongoId()
    .withMessage("Invalid serviceId"), ...ownerSelectionValidation, validate, createServiceCart);
router.post("/package", optionalAuthenticate, body("packageId")
    .notEmpty()
...
router.get("/", optionalAuthenticate, query("page")
    ...
    .optional()
    .isInt({ min: 1, max: 100 })
    .withMessage("limit must be between 1 and 100"), validate, getUserCarts);
// =========================================================
// SHARED VALIDATION
// =========================================================
...
// =========================================================
router.put("/:cartId/components", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("selectedComponents")
    .isArray()
    .withMessage("selectedComponents must be an array"), validate, updateSelectedComponents);
router.put("/:cartId/addon-components", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("addonComponents")
    .isArray()
...
router.put("/:cartId/customer-details", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("bookingFor")
    .optional()
    .isIn([
    "MYSELF",
    "OTHER",
])
    .withMessage("Invalid bookingFor value"), body("name")
    .notEmpty()
    .withMessage("name is required"), body("email")
    .isEmail()
...
router.put("/:cartId/notes", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("notes")
    .optional()
    .isString()
    ...
    .withMessage("notes cannot exceed 1000 characters"), validate, updateCartNotes);
// =========================================================
// CART CALCULATION / VALIDATION
// =========================================================
router.post("/:cartId/recalculate", optionalAuthenticate, cartIdValidation, recalculateCart);
router.post("/:cartId/validate", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("persist")
    .optional()
    .isBoolean()
...
// COUPON ACTIONS
// =========================================================
router.post("/:cartId/apply-coupon", optionalAuthenticate, param("cartId")
    .isMongoId()
    .withMessage("Invalid cartId"), body("couponCode")
    .notEmpty()
    .withMessage("couponCode is required")
    .isString()
    .trim(), validate, applyCoupon);
