...
router.post("/bulk", authenticate, body("serviceId").isMongoId(), body("tierId").isMongoId(), body("components").optional().isArray(), validate, bulkUpsertServiceComponents);
router.put("/replace", authenticate, body("serviceId").isMongoId(), body("tierId").isMongoId(), body("components").optional().isArray(), validate, replaceServiceComponents);
