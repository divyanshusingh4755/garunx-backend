...
const documentUploadValidation = [
    ...
    body("accountNumber")
        ...
        .notEmpty()
        .withMessage("Account number is required when uploading bank passbook")
        .isNumeric()
...
export const coordinatorSettingsValidation = [
    ...
    body("autoAssignmentEnabled")
        ...
        .toBoolean(),
    body().custom((value) => {
        if (value.maxDailyBookings === undefined &&
...
// UPLOADS
router.post("/uploads/single", authenticate, upload.single("image"), uploadSingle);
router.post("/uploads/multiple", authenticate, upload.array("images", 5), uploadMutliple);
