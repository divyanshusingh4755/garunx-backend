...
export const createReview = async (req, res) => {
    try {
        ...
        const createdReview = await ReviewService.createReviewService({
            bookingId,
...
export const moderateReview = async (req, res) => {
    try {
        ...
        const moderatedReview = await ReviewService.moderateReviewService({
            reviewId,
...
export const getMyReviews = async (req, res) => {
    try {
        ...
        const { rating, direction, limit, page, sortBy, sortOrder, } = req.query;
...
export const getCoordinatorReviews = async (req, res) => {
    try {
        ...
        if (!coordinatorId ||
            Array.isArray(coordinatorId)) {
            return res.status(400).json({
                success: false,
                message: "Valid coordinator ID is required",
            });
        }
        const { rating, limit, page, sortBy, sortOrder, } = req.query;
        const result = await ReviewService
