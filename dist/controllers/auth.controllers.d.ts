...
export declare const submitVerificationDocuments: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const approveOrRejectDocs: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getCurrentUser: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const updateCoordinatorApproval: (req: Request, res: Response) => Promise<void>;
export declare const updateCoordinatorAvailability: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
export declare const updateCoordinatorSettings: (req: Request, res: Response) => Promise<Response<any, Record<string, any>> | undefined>;
...
export declare const coordinatorUnavailableDates: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
