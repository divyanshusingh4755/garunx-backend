...
export declare const createComponent: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const updateComponent: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
