...
export declare const getAllCity: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
export declare const getAllCitiesAdmin: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
...
export declare const exportCitiesCsv: (req: Request, res: Response) => Promise<Response<any, Record<string, any>>>;
