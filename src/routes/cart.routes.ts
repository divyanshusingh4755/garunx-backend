...
const objectIdValidation = (field: string) =>
  body(field)
    .notEmpty()
...
const optionalObjectIdValidation = (field: string) =>
  body(field)
    .optional()
    .isMongoId()
    .withMessage(`${field} must be valid Mongo ID`);
...
router.delete(
  "/:cartId/entries",
  authenticate,
  cartController.clearCartEntries,
);

// Entry Routes
router.post(
  "/:cartId/entries/service",
  authenticate,
  addServiceEntryValidation,
  cartController.addServiceEntry,
);
router.post(
  "/:cartId/entries/package",
  authenticate,
  addPackageEntryValidation,
  cartController.addPackageEntry,
);
router.get(
  "/:cartId/entries/:entryId",
  authenticate,
  cartController.getEntryById,
);
router.patch(
  "/:cartId/entries/:entryId",
  authenticate,
  cartController.updateEntry,
);
router.delete(
  "/:cartId/entries/:entryId",
  authenticate,
  cartController.removeEntry,
);

// Component Routes
router.get(
  "/:cartId/entries/:entryId/components",
  authenticate,
  cartController.getEntryComponents,
);
router.patch(
  "/:cartId/entries/:entryId/components/:componentId",
  authenticate,
  updateComponentValidation,
  cartController.updateComponent,
);
router.patch(
  "/:cartId/entries/:entryId/components/:componentId/items",
  authenticate,
  updateComponentItemsValidation,
  cartController.updateComponentItems,
);
router.post(
  "/:cartId/entries/:entryId/components/addon",
  authenticate,
  addAddonComponentValidation,
  cartController.addAddonComponent,
);
router.delete(
  "/:cartId/entries/:entryId/components/:componentId",
  authenticate,
  cartController.removeAddonComponent,
);

// Package Addon service Routes
router.post(
  "/:cartId/entries/:entryId/addon-services",
  authenticate,
  addAddonServiceValidation,
  cartController.addAddonService,
);
router.delete(
  "/:cartId/entries/:entryId/addon-services/:serviceId",
  authenticate,
  cartController.removeAddonService,
);
router.patch(
  "/:cartId/entries/:entryId/services/:serviceId",
  authenticate,
  cartController.updateIncludedService,
);
...
router.post(
  "/:cartId/recalculate",
  authenticate,
  cartController.recalculateCart,
);

router.post(
  "/:cartId/prepare-checkout",
  authenticate,
