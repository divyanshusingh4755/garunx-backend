...
const exportFamilyMembersValidation = [
  body("memberIds")
    ...
    .withMessage(
      "memberIds must contain between 1 and 1000 family member IDs",
    ),

  body("memberIds.*")
    .isMongoId()
    .withMessage(
      "Each memberId must be a valid MongoDB ID",
    ),
