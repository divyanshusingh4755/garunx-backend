...
const createNotificationTemplateValidation = [
    body("code")
        ...
        .isString()
        .withMessage(
            "Template code must be a string",
        )
        .trim()
        .isLength({
            max: 100,
        ...
        .withMessage(
            "Template code cannot exceed 100 characters",
        ),
    ...
    body("preferenceMode")
        .optional()
        .isIn(
            NOTIFICATION_PREFERENCE_MODES,
        )
        .withMessage(
            "Invalid notification preference mode",
        ),
    ...
    body("pushTitle")
        ...
        .withMessage(
            "Push title cannot exceed 200 characters",
        ),
    ...
    body("pushMessage")
        ...
        .withMessage(
            "Push message cannot exceed 2000 characters",
        ),
...
const registerNotificationDeviceValidation = [
    ...
    body("deviceId")
        ...
        .withMessage(
            "Device ID cannot exceed 255 characters",
        ),
...
const updateNotificationPreferencesValidation = [
    ...
    body("categories.booking")
        ...
        .isBoolean()
        .withMessage(
            "categories.booking must be a boolean",
        ),
    ...
    body("categories.payment")
        ...
        .isBoolean()
        .withMessage(
            "categories.payment must be a boolean",
        ),
    ...
    body("categories.query")
        ...
        .isBoolean()
        .withMessage(
            "categories.query must be a boolean",
        ),
    ...
    body("categories.review")
        ...
        .isBoolean()
        .withMessage(
            "categories.review must be a boolean",
        ),
    ...
    body("categories.promotional")
        ...
        .isBoolean()
        .withMessage(
            "categories.promotional must be a boolean",
        ),
    ...
    body("categories.appUpdate")
        ...
        .isBoolean()
        .withMessage(
            "categories.appUpdate must be a boolean",
        ),
    ...
    body("categories.newFeature")
        ...
        .isBoolean()
        .withMessage(
            "categories.newFeature must be a boolean",
        ),
    ...
    body("channels.inApp")
        ...
        .isBoolean()
        .withMessage(
            "channels.inApp must be a boolean",
        ),
...
router.delete(
    "/devices",
    authenticate,
    unregisterNotificationDeviceValidation,
