...
const createPermissionValidator = [
    ...
    body("key")
        ...
        .withMessage(
            "Permission key must follow module.action format, e.g. booking.refund",
        ),
    ...
    body("module")
        ...
        .matches(/^[a-z][a-z0-9_-]*$/)
        .withMessage(
            "Permission module can contain lowercase letters, numbers, hyphens and underscores",
        ),
...
const createRoleValidator = [
    ...
    body("key")
        ...
        .matches(/^[A-Z][A-Z0-9_]*$/)
        .withMessage(
            "Role key must contain only uppercase letters, numbers and underscores",
        ),
...
const addRolePermissionsValidator = [
    ...
    body("permissions.*")
        .isMongoId()
        .withMessage(
            "Each permission must be a valid permission ID",
        ),
...
const exportRolesValidator = [
    body("roleIds")
        ...
        .withMessage(
            "roleIds must be a non-empty array with maximum 100 roles",
        ),

    body("roleIds.*")
        .isMongoId()
        .withMessage(
            "Each roleId must be a valid role ID",
        ),
...
router.patch(
    ...
    authenticate,
    requirePermission("rbac.manage"),
    updatePermissionStatusValidator,
