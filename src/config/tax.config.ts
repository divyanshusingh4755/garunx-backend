...
if (
  ...
  throw new Error(
    "GSTIN must contain exactly 15 uppercase alphanumeric characters",
  );
}
...
if (
  ...
  throw new Error(
    "DEFAULT_CURRENCY must be a three-letter currency code",
  );
}
