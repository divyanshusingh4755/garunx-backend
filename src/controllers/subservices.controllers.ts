...
export const updateSubServiceComponent = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const getAllSubServiceComponents = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const getAllSubServiceComponentsAdmin =
  async (
    req: Request,
    res: Response,
  ) => {
...
export const getSubServiceComponentById = async (
  req: Request,
  res: Response,
) => {
  try {
...
export const toggleSubServiceComponent = async (
  req: Request,
  res: Response,
) => {
  try {
    ...
    return res.status(200).json({
      success: true,
      message: `Sub Service Component ${status ? "activated" : "deactivated"
        } successfully`,
      data: subServiceComponent,
    });
  } catch (error: any) {
