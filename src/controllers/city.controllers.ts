...
export const getAllCitiesAdmin = async (req: Request, res: Response) => {
  try {
...
export const deleteCity = async (req: Request, res: Response) => {
  try {
    ...
    const city = await CityService.softDeleteCity(req.params.id as string, status);
...
export const exportCitiesCsv = async (req: Request, res: Response) => {
  try {
    const cityIds: string[] | undefined = req.body.cityIds;
