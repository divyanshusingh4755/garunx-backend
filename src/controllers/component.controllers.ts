...
export const createComponent = async (req: Request, res: Response) => {
  try {
    ...
    const component = await ComponentService.createComponent({
      ...
      ...(isRemovable !== undefined && { isRemovable }),
      ...(isBundled !== undefined && { isBundled }),
...
export const updateComponent = async (req: Request, res: Response) => {
  try {
    const component = await ComponentService.updateComponent(req.params.componentId as string, req.body);
...
export const toggleComponentStatus = async (req: Request, res: Response) => {
  try {
    ...
    const result = await ComponentService.toggleComponentStatus(req.params.componentId as string, isActive, confirmed);
...
export const getComponentById = async (req: Request, res: Response) => {
  try {
    const component = await ComponentService.getComponentById(req.params.componentId as string);
...
export const getAllComponents = async (req: Request, res: Response) => {
  try {
    ...
    const result = await ComponentService.findComponents({
      ...
      // Public API must never expose inactive components.
      isActive: true,
      ...
      ...(removableStatus !== undefined && { isRemovable: removableStatus }),
      ...(bundledStatus !== undefined && { isBundled: bundledStatus }),
    });
...
export const getAllComponentsAdmin = async (req: Request, res: Response) => {
  try {
...
export const exportComponentsCsv = async (req: Request, res: Response) => {
  try {
    const { componentIds }: { componentIds: string[] } = req.body;

    const result = await ComponentService.exportComponentsToCsv(componentIds);
