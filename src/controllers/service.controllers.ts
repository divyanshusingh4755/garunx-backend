...
export const updateService = async (req: Request, res: Response) => {
  try {
    const service = await ServiceService.updateService(req.params.serviceId as string, req.body);
...
export const toggleServiceStatus = async (req: Request, res: Response) => {
  try {
    ...
    const result = await ServiceService.toggleServiceStatus(req.params.serviceId as string, isActive, confirmed);
...
export const getServiceById = async (req: Request, res: Response) => {
  try {
    const service = await ServiceService.getServiceById(req.params.serviceId as string);
...
export const updateServiceLocations = async (req: Request, res: Response) => {
  try {
    const result = await ServiceService.updateServiceLocations(req.params.id as string, req.body.locations);
...
export const removeServiceLocation = async (req: Request, res: Response) => {
  try {
    const result = await ServiceService.removeServiceLocation(req.params.id as string, req.params.locationId as string);
...
export const updateServiceTiers = async (req: Request, res: Response) => {
  try {
    const result = await ServiceService.updateServiceTiers(req.params.id as string, req.body.tiers);
...
export const removeServiceTier = async (req: Request, res: Response) => {
  try {
    const result = await ServiceService.removeServiceTier(req.params.id as string, req.params.tierId as string);
...
export const getFullServiceAdmin = async (req: Request, res: Response,) => {
  try {
    const data = await ServiceService.getFullServiceAdmin(req.params.serviceId as string);
...
export const getFullService = async (req: Request, res: Response) => {
  try {
    const data = await ServiceService.getFullService(req.params.serviceId as string);
...
export const getFullServiceByCities = async (req: Request, res: Response) => {
  try {
    const data = await ServiceService.getFullServiceByCities(req.params.serviceId as string, req.body.cityIds);
...
export const getServiceDiagnostics = async (req: Request, res: Response) => {
  try {
    const result = await ServiceDiagnosticsEngine.analyze(req.params.serviceId as string);
...
export const exportServicesCsv = async (req: Request, res: Response) => {
  try {
