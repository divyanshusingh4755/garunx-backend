...
export const bulkUpsertServiceComponents = async (req: Request, res: Response) => {
  try {
...
export const getComponentsByServiceAndTier = async (req: Request, res: Response) => {
  try {
    const data = await ServiceComponentService.getComponentsByServiceAndTier(req.params.serviceId as string, req.params.tierId as string);
