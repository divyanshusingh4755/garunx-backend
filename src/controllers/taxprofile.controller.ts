...
export class TaxProfileController {
  ...
  static async list(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (typeof req.query.treatment === "string") {
        filters.treatment = req.query.treatment as TaxTreatment;
      }
  ...
  static async getById(req: Request, res: Response, next: NextFunction) {
    try {
      const taxProfile = await TaxProfileService.getTaxProfileById(
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const payload: UpdateTaxProfilePayload = {
        updatedBy: adminId,
      };
  ...
  static async updateStatus(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const taxProfile = await TaxProfileService.updateTaxProfileStatus(
        req.params.taxProfileId as string,
        req.body.isActive,
        adminId,
      );
