...
export const deleteLocation = async (req: Request, res: Response) => {
  try {
    ...
    const result = await LocationService.softDeleteLocation(id as string, status, confirmed);
...
export const getAllLocationsAdmin = async (req: Request, res: Response) => {
  try {
...
export const exportLocationsCsv = async (req: Request, res: Response) => {
  try {
    const { locationIds }: { locationIds: string[] } = req.body;
