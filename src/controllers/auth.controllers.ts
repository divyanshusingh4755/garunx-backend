    ...
    try {
        ...
        return res.status(200).json({
            ...
            data: {
                identity: {
                    status:
                        updatedUser.documentVerification.status,
                    isVerified:
                        updatedUser.isDocumentVerified,
                },
                bank: {
                    status:
                        updatedUser.bankDocumentVerification.status,
                    isVerified:
                        updatedUser.isBankDocumentVerified,
                },
                coordinatorApproval:
                    updatedUser.coordinatorProfile
                        ?.approvalStatus,
            },
        });
    } catch (error: any) {
...
export const approveOrRejectDocs = async (
    req: Request,
    res: Response,
) => {
    try {
        ...
        return res.status(200).json({
            success: true,
            message:
                `${verificationName} ${status.toLowerCase()} successfully`,
            data: {
...
export const updateCoordinatorApproval = async (
    ...
    try {
        ...
        const coordinator =
            await AuthService.updateCoordinatorApproval(
        ...
        res.status(statusCode).json({
            success: false,
            message:
                error.message || "Failed to update coordinator approval",
        });
    }
};
...
export const updateCoordinatorAvailability = async (
    ...
    try {
        ...
        const data =
            await AuthService.updateCoordinatorAvailability(
                coordinatorId,
...
export const updateCoordinatorSettings = async (
    ...
    try {
        ...
        res.status(statusCode).json({
            success: false,
            message:
                error.message || "Failed to update coordinator settings",
        });
    }
};
...
export const updateServiceableLocations = async (
    ...
    try {
        ...
        const coordinator =
            await AuthService.updateCoordinatorServiceableLocations(
                coordinatorId,
...
export const getCoordinatorById = async (
    ...
    try {
        ...
        const coordinator =
            await AuthService.getCoordinatorById(
                coordinatorId as string,
            );
        ...
        res.status(statusCode).json({
            success: false,
            message:
                error.message || "Failed to fetch coordinator",
        });
    }
};
...
export const getCoordinators = async (
    ...
    try {
        ...
        const filters: Parameters<
            typeof AuthService.getCoordinators
        >[0] = {
            page: Number(page) || 1,
        ...
        const result =
            await AuthService.getCoordinators(filters);
        ...
        res.status(500).json({
            success: false,
            message:
                error.message || "Failed to fetch coordinators",
        });
    }
};