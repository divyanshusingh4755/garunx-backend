...
export const getMyNotifications = async (req: Request, res: Response) => {
    try {
        ...
        const type = typeof req.query.type === "string" ? (req.query.type as NotificationType) : undefined;
...
export const retryNotificationEmail = async (req: Request, res: Response) => {
    try {
        const notificationId = req.params.id;
...
export const retryNotificationPush = async (req: Request, res: Response) => {
    try {
        const notificationId = req.params.id;
