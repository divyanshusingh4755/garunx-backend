...
export class NotificationService {
    ...
    private static async emitUnreadCount(
    ...
    static async createFromTemplate(params: {
        ...
        if (
            ...
            throw new Error(
                `Email content is not configured for notification template ${rendered.code}`,
            );
        }
        ...
        if (
            ...
            throw new Error(
                `Push content is not configured for notification template ${rendered.code}`,
            );
        }
    ...
    static async retryPush(
        ...
        if (
            ...
            throw new Error(
                "Only failed or partially delivered push notifications can be retried",
            );
        }
