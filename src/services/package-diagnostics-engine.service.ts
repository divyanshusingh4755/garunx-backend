...
export class PackageDiagnosticsEngine {
  ...
  static async analyze(
    packageId: string,
  ): Promise<PackageDiagnosticResult> {
    if (
    ...
    const packageDocument =
      await Package.findById(
        packageId,
      ).lean<PackageDiagnosticDocument>();
    ...
    const [
      ...
      PackageTierMap.find({
        packageId:
          packageDocument._id,
      }).lean<TierMappingDocument[]>(),

      PackageTierPricing.find({
        packageId:
          packageDocument._id,
      }).lean<PackagePricingDocument[]>(),
     ...
     */
    if (
      !packageDocument.isActive
    ) {
      issues.push({
        code:
          "PACKAGE_INACTIVE",
        message:
          `Package "${packageDocument.name}" is inactive`,
        severity: "info",
      });
    }
    ...
    if (
      ...
      issues.push({
        code:
          "NO_TIERS",
        message:
          `No tiers configured for package "${packageDocument.name}"`,
        severity: "blocking",
      });
    }

    const malformedTiers =
      packageDocument.tiers.filter(
        (tier) =>
          this.safeObjectIdString(
            tier.tierId,
          ) === null,
    ...
    if (
      ...
      issues.push({
        code:
          "MALFORMED_TIERS",
        message:
          "Some package tiers contain invalid IDs",
        severity: "blocking",
        meta: {
          count:
    ...
    if (
      ...
      issues.push({
        code:
          "DUPLICATE_TIERS",
        message:
          "Some package tiers are configured more than once",
        severity: "blocking",
        meta:
    ...
    if (
      ...
      issues.push({
        code:
          "MALFORMED_LOCATIONS",
        message:
          "Some package locations contain invalid IDs",
        severity: "blocking",
        meta: {
          count:
            malformedLocations.length,
    ...
    if (
      ...
      issues.push({
        code:
          "DUPLICATE_LOCATIONS",
        message:
          "Some package locations are configured more than once",
        severity: "blocking",
        meta:
    ...
    if (
      ...
      issues.push({
        code:
          "INVALID_LOCATIONS",
        message:
          "Some configured package locations are missing or deleted",
        severity: "blocking",
        meta:
    ...
    if (
      inactiveMasterLocations.length >
      0
    ) {
      issues.push({
        code:
        ...
        message:
          "Some active package locations are inactive in the location master",
        severity: "blocking",
        meta:
          inactiveMasterLocations.map(
            (locationId) => ({
              locationId,
              locationName:
                locationMap.get(
    ...
    if (
      ...
      issues.push({
        code:
          "ORPHAN_SERVICE_MAPPINGS",
        message:
          "Some service mappings belong to deleted tiers",
        severity: "warning",
        meta:
          orphanMappings
            .slice(0, 10)
    ...
    const duplicateMappingTierIds =
      this.findDuplicates(
        mappingTierIds,
      );

    if (
      duplicateMappingTierIds.length >
      0
    ) {
      issues.push({
        code:
          "DUPLICATE_TIER_MAPPINGS",
        message:
          "More than one package mapping exists for the same tier",
        severity: "blocking",
        meta:
          duplicateMappingTierIds.map(
            (tierId) => ({
              tierId,
              tierName:
                tierMap.get(
    ...
    if (
      tiersWithoutServices.length >
      0
    ) {
      issues.push({
        code:
          "TIERS_WITHOUT_SERVICES",
        message:
          "Some package tiers have no mapped services",
        severity: "blocking",
        meta:
          tiersWithoutServices.map(
            (tierId) => ({
              tierId,
              tierName:
                tierMap.get(
    ...
    if (
      ...
      issues.push({
        code:
          "MALFORMED_SERVICES",
        message:
          "Some mapped services contain invalid IDs",
        severity: "blocking",
        meta: {
          count:
            malformedServices.length,
        },
      });
    }
    ...
    if (
      ...
      issues.push({
        code:
          "INVALID_SERVICES",
        message:
          "Some mapped services are missing or deleted",
        severity: "blocking",
        meta:
          invalidServices
            .slice(0, 10)
    ...
    if (
      ...
      issues.push({
        code:
          "INACTIVE_SERVICES",
        message:
          "Some mapped services are inactive",
        severity: "blocking",
        meta: [
          ...new Set(
            inactiveServices,
    ...
    const duplicateMappedServices =
      this.findDuplicates(
        mappedCombinationKeys,
      );

    if (
      duplicateMappedServices.length >
      0
    ) {
      issues.push({
        code:
          "DUPLICATE_MAPPED_SERVICES",
        message:
          "Some services are mapped more than once in the same tier",
        severity: "blocking",
        meta: {
          count:
            duplicateMappedServices.length,
          samples:
            duplicateMappedServices.slice(
              0,
              10,
            ),
        },
    ...
    if (
      ...
      issues.push({
        code:
          "DUPLICATE_PRICING",
        message:
          "Duplicate package pricing rows exist",
        severity: "blocking",
        meta: {
          count:
    ...
    for (
      ...
      /*
       * This intentionally checks every mapped service.
       * PackageCascadingEngine also requires pricing for
    ...
    if (
      ...
      issues.push({
        code:
          "MISSING_PRICING",
        message:
          "Missing pricing for mapped service combinations",
        severity: "blocking",
        meta: {
          count:
