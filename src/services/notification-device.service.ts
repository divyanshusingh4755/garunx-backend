...
export class NotificationDeviceService {
    static async registerDevice(params: {
         ...
         *
         * If this token already belongs to another user,
         * reassign it to the currently authenticated user.
         *
         * This can happen when:
         * User A logs out from a device
