...
export class NotificationTemplateService {
    ...
    static async createTemplate(params: {
        ...
        if (
            !isValidPreferenceModeForCategory(
                params.category,
                preferenceMode,
            )
        ) {
            throw new Error(
                `Invalid preference mode ${preferenceMode} for notification category ${params.category}`,
            );
        }
    ...
    static async updateTemplate(params: {
        ...
        const currentTemplate =
            await NotificationTemplate.findById(
                templateId,
            );
        ...
        if (
            !isValidPreferenceModeForCategory(
                effectiveCategory,
                effectivePreferenceMode,
            )
        ) {
            throw new Error(
                `Invalid preference mode ${effectivePreferenceMode} for notification category ${effectiveCategory}`,
            );
        }
