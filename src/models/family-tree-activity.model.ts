...
const familyTreeChangeSchema = new Schema<IFamilyTreeChange>(
  {
    field: {
      type: String,
      required: true,
...
const familyTreeActivitySchema = new Schema<IFamilyTreeActivity>(
  {
    ownerId: {
...
familyTreeActivitySchema.pre("validate", function (): void {
