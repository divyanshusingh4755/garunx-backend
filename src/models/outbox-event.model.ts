...
import { DOMAIN_EVENTS, type DomainEventType } from "../events/domain-events.js";
...
export const OutboxEvent: Model<IOutboxEvent> = model<IOutboxEvent>("OutboxEvent", outboxEventSchema);