...
export const PUSH_DELIVERY_STATUSES = ["NOT_REQUESTED", "PENDING", "RETRYING", "SENT", "PARTIAL", "FAILED"] as const;
export type PushDeliveryStatus = (typeof PUSH_DELIVERY_STATUSES)[number];

export const EMAIL_DELIVERY_STATUSES = ["NOT_REQUESTED", "PENDING", "RETRYING", "SENT", "FAILED"] as const;
export type EmailDeliveryStatus = (typeof EMAIL_DELIVERY_STATUSES)[number];

export const NOTIFICATION_TYPES = ["BOOKING", "PAYMENT", "QUERY", "REVIEW", "SYSTEM"] as const;
