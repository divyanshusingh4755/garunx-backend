...
export type CoordinatorSortBy =
    | "rating"
    | "completedBookings"
    | "acceptanceRate";

export type CoordinatorSortOrder =
    | "asc"
    | "desc";

export interface ICoordinatorSelectionConfig
    extends Document {
    key: "DEFAULT";
...
const coordinatorSelectionConfigSchema =
    new Schema<ICoordinatorSelectionConfig>(
        {
            /*
...
export const CoordinatorSelectionConfig =
    model<ICoordinatorSelectionConfig>(
        "CoordinatorSelectionConfig",
        coordinatorSelectionConfigSchema,
    );