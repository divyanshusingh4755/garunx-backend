    ...
    CouponNotificationTemplateSeed[] = [
        {
            ...
            message:
                "{{couponName}} has been added to your account. Use code {{couponCode}} to get {{discountText}} off. Validity: {{validityText}}.",

            emailSubject:
                "You received a new coupon: {{couponCode}}",

            emailBody:
                "A new coupon has been assigned to your account. Coupon: {{couponName}}. Code: {{couponCode}}. Discount: {{discountText}}. Validity: {{validityText}}.",

            pushTitle:
                "New coupon for you",

            pushMessage:
                "Use {{couponCode}} to get {{discountText}} off.",
