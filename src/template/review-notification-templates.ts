    ...
    ReviewNotificationTemplateSeed[] = [
        {
            ...
            message:
                "You received a {{rating}}-star review for booking {{bookingReference}}.",

            pushTitle:
                "New review received",

            pushMessage:
                "You received a {{rating}}-star review for {{bookingReference}}.",
...

        {
            ...
            message:
                "Your review for booking {{bookingReference}} was removed by an administrator. Reason: {{reason}}.",
            ...
            pushMessage:
                "Your review for {{bookingReference}} was removed by an administrator.",
